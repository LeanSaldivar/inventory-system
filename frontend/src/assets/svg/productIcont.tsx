...
export const ProductIcon = (props: SVGProps<SVGSVGElement>) =>
    <svg
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path d="M7.5 4.5L16.5 9.5V13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M6 12.3281L9 14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M3 7L12 12M12 12L21 7M12 12V21.5" stroke="currentColor" stroke-width="2" stroke-linejoin="round"></path> </g>
    </svg>